...
#
#   setup do
#     start_supervised!({DynamicSupervisor, strategy: :one_for_one, name: TestApp.ListenerDynamicSupervisor})
#
#     :ok
#   end
#
...
#     config = %{
#       listener_supervisor: TestApp.ListenerDynamicSupervisor,
#       channel: "my-channel",
#       callback: nil,
#       spine: nil,
#       notifier: nil
...
#
#     assert_receive(:subscribe_to_event_store)
#   end
#
